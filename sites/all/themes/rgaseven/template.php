 ...
 */
function rgaseven_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // rgaseven_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  rgaseven_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function rgaseven_preprocess_html(&$vars) {
 ...
 */
function rgaseven_preprocess_page(&$vars) {
 ...
 */
function rgaseven_node_add_list($variables) {
 ...
 */
function rgaseven_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function rgaseven_tablesort_indicator($variables) {
 ...
 */
function rgaseven_css_alter(&$css) {
